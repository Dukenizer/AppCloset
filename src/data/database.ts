...
INSERT OR IGNORE INTO app_settings(key, value) VALUES ('app_theme', 'dark');
...
/** Rebuild artworks so status CHECK allows Reserved (gallery hold sticker). */
const migrationV10 = `
PRAGMA foreign_keys=OFF;
...
UPDATE app_settings SET value = '10', updated_at = CURRENT_TIMESTAMP WHERE key = 'schema_version';
